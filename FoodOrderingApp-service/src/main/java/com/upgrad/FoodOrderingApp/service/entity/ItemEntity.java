...
@Entity
@Table(name="item")
@NamedQueries({@NamedQuery(name = "itemByUUID", query = "select i from ItemEntity i where i.uuid=:itemUUID")})
////@NamedQuery(name="getItemById", query="SELECT i from ItemEntity i where i.id = :id"),
////        @NamedQuery(
