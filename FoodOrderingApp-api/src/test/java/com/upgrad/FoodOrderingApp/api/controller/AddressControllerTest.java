    ...
    public void shouldNotSaveAddressWithNonExistingAccessToken() throws Exception {
        ...
        mockMvc
                .perform(post("/address?content=my_address")
                        ...
                        .content("{\"flat_building_name\":\"xyz\", \"locality\":\"abc\", \"city\":\"pqr\", \"pincode\":\"123456\", \"state_uuid\":\"testUUID\"}"))//THIS is required as the documentation says body is required
